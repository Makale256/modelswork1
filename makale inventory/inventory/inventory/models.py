...
class Product (models.Model):
    ...
    product_name=models.CharField(max_length=234,)
    unit_price=models.IntegerField(max_length=50,)
...
class Transaction (models.Models):
   ...
   stock_taken=models.IntegerField(max_length=107,null=True)
   transaction_amount=models.IntegerField(max_length=205,null=True)
